...
| hide_delete_torrent      | boolean      | optional     | false                   | hide delete torrent button (compact and full mode) |
| hide_delete_torrent_full | boolean      | optional     | false                   | hide delete torrent with data button (full mode only) |
